...
def train_model(net_model, dataDir,outputfile):
    ...
    train_samples = make_sample_list("steering", train_data,expand_data=True, expand_correction=0.08)
    ...
    plt.show()
    plt.savefig(model+'_convergence_history.png')
...
def main(argv):
    ...
    try:
        ...
        print ('python clone_behavior.py -h -t [on/off] -d <data_dir> -m model [lenet/nvidia]')
